...
// Climate
// Gravity
// There should be a function that makes the call to the api for the planets(should have URL for a parameter ) There 
// should be a function that prints planets in to the table ** API URL: ** https://swapi.dev/api/planets/?page=1
...
button.addEventListener('click', () => {
    ...
    for (let i = 0; i < res.results.lenght; i++) {
        table.innerHTML += `<tr>
        <td>${results.name}</td>
